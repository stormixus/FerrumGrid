...
fn insert_recent_ui_en(en: &mut Translation) {
    ...
    en.insert("tree_history_empty", "No queries yet");
    ...
    en.insert("tree_snippets_empty", "No snippets saved yet");
    en.insert("snippet_save_from_editor", "Save from editor");
    en.insert("snippet_saved", "Snippet saved");
    en.insert("snippet_deleted", "Snippet deleted");
    en.insert("snippet_insert", "Insert");
    en.insert("snippet_rename", "Rename");
    en.insert("snippet_rename_ok", "OK");
    en.insert("snippet_delete", "Delete");
    en.insert("cmd_open_snippets", "Open Snippets");
    en.insert("cmd_hint_open_snippets", "Saved query library");
    en.insert("cmd_sec_snippets", "Snippets");
    en.insert("cmd_hint_open_snippet", "Open snippet in editor");
    en.insert("drop_irreversible", "This action cannot be undone (DROP CASCADE).");
    en.insert("drop_dependents_title", "Dependents preview");
    en.insert("drop_dependents_loading", "Loading dependents…");
    en.insert("drop_dependents_oid_unavailable", "Could not resolve object OID — dependents preview unavailable.");
    en.insert("drop_dependents_fetch_failed", "Failed to load dependents: {0}");
    en.insert("drop_dependents_none", "No dependent objects found.");
    en.insert("drop_dependents_count", "Showing all {0} dependents");
    en.insert("drop_dependents_truncated", "Showing first {0} of more than {1} dependents (truncated)");
    en.insert("drop_cascade_confirm", "Drop CASCADE");

    // SSH tunnel
    en.insert("connection_ssh_enable", "Enable SSH tunnel");
    en.insert("connection_ssh_host", "SSH host");
    en.insert("connection_ssh_port", "SSH port");
    en.insert("connection_ssh_username", "SSH username");
    en.insert("connection_ssh_password", "SSH password");

    // AI Assist
    en.insert("ai_assist_title", "AI Assist");
    en.insert("ai_assist_button", "AI Assist");
    en.insert("ai_assist_prompt_label", "Describe the query you want in plain language:");
    en.insert("ai_assist_prompt_hint", "e.g. List all users created this month");
    en.insert("ai_assist_generate", "Generate SQL");
    en.insert("ai_assist_insert", "Insert into editor");
    en.insert("ai_assist_generating", "Generating SQL…");
    en.insert("ai_assist_preview", "Generated SQL");
    en.insert("ai_assist_trust_note", "Review before running — SQL is never executed automatically.");
    en.insert("ai_assist_disabled", "Enable AI assistant in Settings → AI Assist.");
    en.insert("ai_assist_inserted", "SQL inserted into editor");
    en.insert("ai_assist_failed", "AI request failed");
    en.insert("cmd_ai_assist", "AI Assist");
    en.insert("cmd_hint_ai_assist", "Natural language to SQL");
    en.insert("settings_desc_ai_assistant", "Enable natural-language SQL generation");
    en.insert("settings_row_ai_endpoint", "API endpoint");
    en.insert("settings_desc_ai_endpoint", "Override default URL (optional)");
    en.insert("settings_row_ai_api_key", "API key");
    en.insert("settings_desc_ai_api_key", "Or set OPENAI_API_KEY / ANTHROPIC_API_KEY");

    // Snippet save dialog
    en.insert("snippet_save_title", "Save Snippet");
    en.insert("snippet_save_name", "Name");
    en.insert("snippet_save_tags", "Tags");
    en.insert("snippet_save_tags_hint", "Comma-separated, e.g. reporting, daily");
    en.insert("editor_save_snippet", "Save");
...
fn insert_recent_ui_ko(ko: &mut Translation) {
    ...
    ko.insert("tree_history_empty", "아직 실행한 쿼리가 없습니다");
    ...
    ko.insert("tree_snippets_empty", "저장된 스니펫이 없습니다");
    ko.insert("snippet_save_from_editor", "에디터에서 저장");
    ko.insert("snippet_saved", "스니펫이 저장되었습니다");
    ko.insert("snippet_deleted", "스니펫이 삭제되었습니다");
    ko.insert("snippet_insert", "삽입");
    ko.insert("snippet_rename", "이름 변경");
    ko.insert("snippet_rename_ok", "확인");
    ko.insert("snippet_delete", "삭제");
    ko.insert("cmd_open_snippets", "스니펫 열기");
    ko.insert("cmd_hint_open_snippets", "저장된 쿼리 라이브러리");
    ko.insert("cmd_sec_snippets", "스니펫");
    ko.insert("cmd_hint_open_snippet", "에디터에서 스니펫 열기");
    ko.insert("drop_irreversible", "이 작업은 되돌릴 수 없습니다 (DROP CASCADE).");
    ko.insert("drop_dependents_title", "종속 객체 미리보기");
    ko.insert("drop_dependents_loading", "종속 객체 불러오는 중…");
    ko.insert("drop_dependents_oid_unavailable", "객체 OID를 찾을 수 없어 종속 객체 미리보기를 사용할 수 없습니다.");
    ko.insert("drop_dependents_fetch_failed", "종속 객체를 불러오지 못했습니다: {0}");
    ko.insert("drop_dependents_none", "종속 객체가 없습니다.");
    ko.insert("drop_dependents_count", "종속 객체 {0}개 전체 표시");
    ko.insert("drop_dependents_truncated", "종속 객체 {1}개 이상 중 처음 {0}개만 표시 (잘림)");
    ko.insert("drop_cascade_confirm", "DROP CASCADE");

    ko.insert("connection_ssh_enable", "SSH 터널 사용");
    ko.insert("connection_ssh_host", "SSH 호스트");
    ko.insert("connection_ssh_port", "SSH 포트");
    ko.insert("connection_ssh_username", "SSH 사용자명");
    ko.insert("connection_ssh_password", "SSH 비밀번호");

    ko.insert("ai_assist_title", "AI 어시스트");
    ko.insert("ai_assist_button", "AI 어시스트");
    ko.insert("ai_assist_prompt_label", "원하는 쿼리를 자연어로 설명하세요:");
    ko.insert("ai_assist_prompt_hint", "예: 이번 달에 생성된 사용자 목록");
    ko.insert("ai_assist_generate", "SQL 생성");
    ko.insert("ai_assist_insert", "에디터에 삽입");
    ko.insert("ai_assist_generating", "SQL 생성 중…");
    ko.insert("ai_assist_preview", "생성된 SQL");
    ko.insert("ai_assist_trust_note", "실행 전 검토하세요 — SQL은 자동 실행되지 않습니다.");
    ko.insert("ai_assist_disabled", "설정 → AI 어시스트에서 AI 어시스턴트를 활성화하세요.");
    ko.insert("ai_assist_inserted", "에디터에 SQL이 삽입되었습니다");
    ko.insert("ai_assist_failed", "AI 요청 실패");
    ko.insert("cmd_ai_assist", "AI 어시스트");
    ko.insert("cmd_hint_ai_assist", "자연어를 SQL로 변환");
    ko.insert("settings_desc_ai_assistant", "자연어 SQL 생성 사용");
    ko.insert("settings_row_ai_endpoint", "API 엔드포인트");
    ko.insert("settings_desc_ai_endpoint", "기본 URL 재정의 (선택)");
    ko.insert("settings_row_ai_api_key", "API 키");
    ko.insert("settings_desc_ai_api_key", "또는 OPENAI_API_KEY / ANTHROPIC_API_KEY 환경 변수");

    ko.insert("snippet_save_title", "스니펫 저장");
    ko.insert("snippet_save_name", "이름");
    ko.insert("snippet_save_tags", "태그");
    ko.insert("snippet_save_tags_hint", "쉼표로 구분, 예: reporting, daily");
    ko.insert("editor_save_snippet", "저장");
...
fn insert_recent_ui_ja(ja: &mut Translation) {
    ...
    ja.insert("tree_snippets_title", "保存済みスニペット");
    ja.insert("tree_snippets_desc", "よく使うクエリをここに保存");
    ja.insert("tree_history_empty", "クエリはまだありません");
    ja.insert("tree_snippets_empty", "保存されたスニペットはありません");
    ja.insert("snippet_save_from_editor", "エディターから保存");
    ja.insert("snippet_saved", "スニペットを保存しました");
    ja.insert("snippet_deleted", "スニペットを削除しました");
    ja.insert("snippet_insert", "挿入");
    ja.insert("snippet_rename", "名前変更");
    ja.insert("snippet_rename_ok", "OK");
    ja.insert("snippet_delete", "削除");
    ja.insert("cmd_open_snippets", "スニペットを開く");
    ja.insert("cmd_hint_open_snippets", "保存済みクエリライブラリ");
    ja.insert("cmd_sec_snippets", "スニペット");
    ja.insert("cmd_hint_open_snippet", "エディターでスニペットを開く");
    ja.insert("drop_irreversible", "この操作は元に戻せません（DROP CASCADE）。");
    ja.insert("drop_dependents_title", "依存オブジェクトのプレビュー");
    ja.insert("drop_dependents_loading", "依存オブジェクトを読み込み中…");
    ja.insert("drop_dependents_oid_unavailable", "オブジェクト OID を解決できません — 依存プレビューは利用できません。");
    ja.insert("drop_dependents_fetch_failed", "依存オブジェクトの読み込みに失敗: {0}");
    ja.insert("drop_dependents_none", "依存オブジェクトは見つかりませんでした。");
    ja.insert("drop_dependents_count", "依存オブジェクト {0} 件をすべて表示");
    ja.insert("drop_dependents_truncated", "依存オブジェクト {1} 件以上のうち最初の {0} 件を表示（省略）");
    ja.insert("drop_cascade_confirm", "DROP CASCADE");
    ja.insert("connection_ssh_enable", "SSH トンネルを有効化");
    ja.insert("connection_ssh_host", "SSH ホスト");
    ja.insert("connection_ssh_port", "SSH ポート");
    ja.insert("connection_ssh_username", "SSH ユーザー名");
    ja.insert("connection_ssh_password", "SSH パスワード");
    ja.insert("ai_assist_title", "AI アシスト");
    ja.insert("ai_assist_button", "AI アシスト");
    ja.insert("ai_assist_prompt_label", "欲しいクエリを自然言語で説明してください:");
    ja.insert("ai_assist_prompt_hint", "例: 今月作成されたユーザーを一覧");
    ja.insert("ai_assist_generate", "SQL を生成");
    ja.insert("ai_assist_insert", "エディターに挿入");
    ja.insert("ai_assist_generating", "SQL を生成中…");
    ja.insert("ai_assist_preview", "生成された SQL");
    ja.insert("ai_assist_trust_note", "実行前に確認してください — SQL は自動実行されません。");
    ja.insert("ai_assist_disabled", "設定 → AI アシストで AI アシスタントを有効にしてください。");
    ja.insert("ai_assist_inserted", "エディターに SQL を挿入しました");
    ja.insert("ai_assist_failed", "AI リクエストに失敗しました");
    ja.insert("cmd_ai_assist", "AI アシスト");
    ja.insert("cmd_hint_ai_assist", "自然言語から SQL へ");
    ja.insert("settings_desc_ai_assistant", "自然言語 SQL 生成を有効化");
    ja.insert("settings_row_ai_endpoint", "API エンドポイント");
    ja.insert("settings_desc_ai_endpoint", "デフォルト URL を上書き（任意）");
    ja.insert("settings_row_ai_api_key", "API キー");
    ja.insert("settings_desc_ai_api_key", "または OPENAI_API_KEY / ANTHROPIC_API_KEY");
    ja.insert("snippet_save_title", "スニペットを保存");
    ja.insert("snippet_save_name", "名前");
    ja.insert("snippet_save_tags", "タグ");
    ja.insert("snippet_save_tags_hint", "カンマ区切り、例: reporting, daily");
    ja.insert("editor_save_snippet", "保存");
...
fn insert_recent_ui_zh(zh: &mut Translation) {
    ...
    zh.insert("tree_snippets_title", "已保存片段");
    zh.insert("tree_snippets_desc", "在此保存常用查询");
    zh.insert("tree_history_empty", "暂无查询记录");
    zh.insert("tree_snippets_empty", "尚未保存片段");
    zh.insert("snippet_save_from_editor", "从编辑器保存");
    zh.insert("snippet_saved", "片段已保存");
    zh.insert("snippet_deleted", "片段已删除");
    zh.insert("snippet_insert", "插入");
    zh.insert("snippet_rename", "重命名");
    zh.insert("snippet_rename_ok", "确定");
    zh.insert("snippet_delete", "删除");
    zh.insert("cmd_open_snippets", "打开片段");
    zh.insert("cmd_hint_open_snippets", "已保存查询库");
    zh.insert("cmd_sec_snippets", "片段");
    zh.insert("cmd_hint_open_snippet", "在编辑器中打开片段");
    zh.insert("drop_irreversible", "此操作无法撤销（DROP CASCADE）。");
    zh.insert("drop_dependents_title", "依赖对象预览");
    zh.insert("drop_dependents_loading", "正在加载依赖对象…");
    zh.insert("drop_dependents_oid_unavailable", "无法解析对象 OID — 依赖预览不可用。");
    zh.insert("drop_dependents_fetch_failed", "加载依赖对象失败：{0}");
    zh.insert("drop_dependents_none", "未找到依赖对象。");
    zh.insert("drop_dependents_count", "显示全部 {0} 个依赖对象");
    zh.insert("drop_dependents_truncated", "显示超过 {1} 个依赖对象中的前 {0} 个（已截断）");
    zh.insert("drop_cascade_confirm", "DROP CASCADE");
    zh.insert("connection_ssh_enable", "启用 SSH 隧道");
    zh.insert("connection_ssh_host", "SSH 主机");
    zh.insert("connection_ssh_port", "SSH 端口");
    zh.insert("connection_ssh_username", "SSH 用户名");
    zh.insert("connection_ssh_password", "SSH 密码");
    zh.insert("ai_assist_title", "AI 助手");
    zh.insert("ai_assist_button", "AI 助手");
    zh.insert("ai_assist_prompt_label", "用自然语言描述您想要的查询：");
    zh.insert("ai_assist_prompt_hint", "例如：列出本月创建的用户");
    zh.insert("ai_assist_generate", "生成 SQL");
    zh.insert("ai_assist_insert", "插入到编辑器");
    zh.insert("ai_assist_generating", "正在生成 SQL…");
    zh.insert("ai_assist_preview", "生成的 SQL");
    zh.insert("ai_assist_trust_note", "运行前请检查 — SQL 不会自动执行。");
    zh.insert("ai_assist_disabled", "请在设置 → AI 助手中启用 AI 助手。");
    zh.insert("ai_assist_inserted", "SQL 已插入编辑器");
    zh.insert("ai_assist_failed", "AI 请求失败");
    zh.insert("cmd_ai_assist", "AI 助手");
    zh.insert("cmd_hint_ai_assist", "自然语言转 SQL");
    zh.insert("settings_desc_ai_assistant", "启用自然语言 SQL 生成");
    zh.insert("settings_row_ai_endpoint", "API 端点");
    zh.insert("settings_desc_ai_endpoint", "覆盖默认 URL（可选）");
    zh.insert("settings_row_ai_api_key", "API 密钥");
    zh.insert("settings_desc_ai_api_key", "或设置 OPENAI_API_KEY / ANTHROPIC_API_KEY");
    zh.insert("snippet_save_title", "保存片段");
    zh.insert("snippet_save_name", "名称");
    zh.insert("snippet_save_tags", "标签");
    zh.insert("snippet_save_tags_hint", "逗号分隔，例如 reporting, daily");
    zh.insert("editor_save_snippet", "保存");
...
fn insert_recent_ui_es(es: &mut Translation) {
    ...
    es.insert("tree_history_empty", "Aún no hay consultas");
    es.insert("tree_snippets_empty", "No hay fragmentos guardados");
    es.insert("snippet_save_from_editor", "Guardar desde el editor");
    es.insert("snippet_saved", "Fragmento guardado");
    es.insert("snippet_deleted", "Fragmento eliminado");
    es.insert("snippet_insert", "Insertar");
    es.insert("snippet_rename", "Renombrar");
    es.insert("snippet_rename_ok", "OK");
    es.insert("snippet_delete", "Eliminar");
    es.insert("cmd_open_snippets", "Abrir fragmentos");
    es.insert("cmd_hint_open_snippets", "Biblioteca de consultas guardadas");
    es.insert("cmd_sec_snippets", "Fragmentos");
    es.insert("cmd_hint_open_snippet", "Abrir fragmento en el editor");
    es.insert("drop_irreversible", "Esta acción no se puede deshacer (DROP CASCADE).");
    es.insert("drop_dependents_title", "Vista previa de dependientes");
    es.insert("drop_dependents_loading", "Cargando dependientes…");
    es.insert("drop_dependents_oid_unavailable", "No se pudo resolver el OID — vista previa no disponible.");
    es.insert("drop_dependents_fetch_failed", "Error al cargar dependientes: {0}");
    es.insert("drop_dependents_none", "No se encontraron objetos dependientes.");
    es.insert("drop_dependents_count", "Mostrando los {0} dependientes");
    es.insert("drop_dependents_truncated", "Mostrando los primeros {0} de más de {1} dependientes");
    es.insert("drop_cascade_confirm", "DROP CASCADE");
    es.insert("connection_ssh_enable", "Habilitar túnel SSH");
    es.insert("connection_ssh_host", "Host SSH");
    es.insert("connection_ssh_port", "Puerto SSH");
    es.insert("connection_ssh_username", "Usuario SSH");
    es.insert("connection_ssh_password", "Contraseña SSH");
    es.insert("ai_assist_title", "Asistente IA");
    es.insert("ai_assist_button", "Asistente IA");
    es.insert("ai_assist_prompt_label", "Describe la consulta en lenguaje natural:");
    es.insert("ai_assist_prompt_hint", "p. ej. Listar usuarios creados este mes");
    es.insert("ai_assist_generate", "Generar SQL");
    es.insert("ai_assist_insert", "Insertar en el editor");
    es.insert("ai_assist_generating", "Generando SQL…");
    es.insert("ai_assist_preview", "SQL generado");
    es.insert("ai_assist_trust_note", "Revise antes de ejecutar — el SQL nunca se ejecuta automáticamente.");
    es.insert("ai_assist_disabled", "Active el asistente IA en Ajustes → Asistente IA.");
    es.insert("ai_assist_inserted", "SQL insertado en el editor");
    es.insert("ai_assist_failed", "Error en la solicitud de IA");
    es.insert("cmd_ai_assist", "Asistente IA");
    es.insert("cmd_hint_ai_assist", "Lenguaje natural a SQL");
    es.insert("settings_desc_ai_assistant", "Habilitar generación SQL en lenguaje natural");
    es.insert("settings_row_ai_endpoint", "Endpoint de API");
    es.insert("settings_desc_ai_endpoint", "Anular URL predeterminada (opcional)");
    es.insert("settings_row_ai_api_key", "Clave API");
    es.insert("settings_desc_ai_api_key", "O configure OPENAI_API_KEY / ANTHROPIC_API_KEY");
    es.insert("snippet_save_title", "Guardar fragmento");
    es.insert("snippet_save_name", "Nombre");
    es.insert("snippet_save_tags", "Etiquetas");
    es.insert("snippet_save_tags_hint", "Separadas por comas, p. ej. reporting, daily");
    es.insert("editor_save_snippet", "Guardar");
...
fn insert_recent_ui_fr(fr: &mut Translation) {
    ...
    fr.insert("tree_history_empty", "Aucune requête pour l'instant");
    fr.insert("tree_snippets_empty", "Aucun extrait enregistré");
    fr.insert("snippet_save_from_editor", "Enregistrer depuis l'éditeur");
    fr.insert("snippet_saved", "Extrait enregistré");
    fr.insert("snippet_deleted", "Extrait supprimé");
    fr.insert("snippet_insert", "Insérer");
    fr.insert("snippet_rename", "Renommer");
    fr.insert("snippet_rename_ok", "OK");
    fr.insert("snippet_delete", "Supprimer");
    fr.insert("cmd_open_snippets", "Ouvrir les extraits");
    fr.insert("cmd_hint_open_snippets", "Bibliothèque de requêtes");
    fr.insert("cmd_sec_snippets", "Extraits");
    fr.insert("cmd_hint_open_snippet", "Ouvrir l'extrait dans l'éditeur");
    fr.insert("drop_irreversible", "Cette action est irréversible (DROP CASCADE).");
    fr.insert("drop_dependents_title", "Aperçu des dépendances");
    fr.insert("drop_dependents_loading", "Chargement des dépendances…");
    fr.insert("drop_dependents_oid_unavailable", "OID introuvable — aperçu des dépendances indisponible.");
    fr.insert("drop_dependents_fetch_failed", "Échec du chargement des dépendances : {0}");
    fr.insert("drop_dependents_none", "Aucun objet dépendant trouvé.");
    fr.insert("drop_dependents_count", "Affichage des {0} dépendances");
    fr.insert("drop_dependents_truncated", "Affichage des {0} premières sur plus de {1} dépendances");
    fr.insert("drop_cascade_confirm", "DROP CASCADE");
    fr.insert("connection_ssh_enable", "Activer le tunnel SSH");
    fr.insert("connection_ssh_host", "Hôte SSH");
    fr.insert("connection_ssh_port", "Port SSH");
    fr.insert("connection_ssh_username", "Utilisateur SSH");
    fr.insert("connection_ssh_password", "Mot de passe SSH");
    fr.insert("ai_assist_title", "Assistant IA");
    fr.insert("ai_assist_button", "Assistant IA");
    fr.insert("ai_assist_prompt_label", "Décrivez la requête en langage naturel :");
    fr.insert("ai_assist_prompt_hint", "p. ex. Lister les utilisateurs créés ce mois-ci");
    fr.insert("ai_assist_generate", "Générer le SQL");
    fr.insert("ai_assist_insert", "Insérer dans l'éditeur");
    fr.insert("ai_assist_generating", "Génération du SQL…");
    fr.insert("ai_assist_preview", "SQL généré");
    fr.insert("ai_assist_trust_note", "Vérifiez avant d'exécuter — le SQL n'est jamais exécuté automatiquement.");
    fr.insert("ai_assist_disabled", "Activez l'assistant IA dans Réglages → Assistant IA.");
    fr.insert("ai_assist_inserted", "SQL inséré dans l'éditeur");
    fr.insert("ai_assist_failed", "Échec de la requête IA");
    fr.insert("cmd_ai_assist", "Assistant IA");
    fr.insert("cmd_hint_ai_assist", "Langage naturel vers SQL");
    fr.insert("settings_desc_ai_assistant", "Activer la génération SQL en langage naturel");
    fr.insert("settings_row_ai_endpoint", "Point de terminaison API");
    fr.insert("settings_desc_ai_endpoint", "Remplacer l'URL par défaut (facultatif)");
    fr.insert("settings_row_ai_api_key", "Clé API");
    fr.insert("settings_desc_ai_api_key", "Ou définir OPENAI_API_KEY / ANTHROPIC_API_KEY");
    fr.insert("snippet_save_title", "Enregistrer l'extrait");
    fr.insert("snippet_save_name", "Nom");
    fr.insert("snippet_save_tags", "Étiquettes");
    fr.insert("snippet_save_tags_hint", "Séparées par des virgules, p. ex. reporting, daily");
    fr.insert("editor_save_snippet", "Enregistrer");
...
fn insert_recent_ui_de(de: &mut Translation) {
    ...
    de.insert("tree_history_empty", "Noch keine Abfragen");
    de.insert("tree_snippets_empty", "Keine Snippets gespeichert");
    de.insert("snippet_save_from_editor", "Aus Editor speichern");
    de.insert("snippet_saved", "Snippet gespeichert");
    de.insert("snippet_deleted", "Snippet gelöscht");
    de.insert("snippet_insert", "Einfügen");
    de.insert("snippet_rename", "Umbenennen");
    de.insert("snippet_rename_ok", "OK");
    de.insert("snippet_delete", "Löschen");
    de.insert("cmd_open_snippets", "Snippets öffnen");
    de.insert("cmd_hint_open_snippets", "Gespeicherte Abfragen");
    de.insert("cmd_sec_snippets", "Snippets");
    de.insert("cmd_hint_open_snippet", "Snippet im Editor öffnen");
    de.insert("drop_irreversible", "Diese Aktion kann nicht rückgängig gemacht werden (DROP CASCADE).");
    de.insert("drop_dependents_title", "Vorschau abhängiger Objekte");
    de.insert("drop_dependents_loading", "Abhängige Objekte werden geladen…");
    de.insert("drop_dependents_oid_unavailable", "OID nicht auflösbar — Vorschau nicht verfügbar.");
    de.insert("drop_dependents_fetch_failed", "Laden abhängiger Objekte fehlgeschlagen: {0}");
    de.insert("drop_dependents_none", "Keine abhängigen Objekte gefunden.");
    de.insert("drop_dependents_count", "Alle {0} abhängigen Objekte anzeigen");
    de.insert("drop_dependents_truncated", "Erste {0} von mehr als {1} abhängigen Objekten");
    de.insert("drop_cascade_confirm", "DROP CASCADE");
    de.insert("connection_ssh_enable", "SSH-Tunnel aktivieren");
    de.insert("connection_ssh_host", "SSH-Host");
    de.insert("connection_ssh_port", "SSH-Port");
    de.insert("connection_ssh_username", "SSH-Benutzername");
    de.insert("connection_ssh_password", "SSH-Passwort");
    de.insert("ai_assist_title", "KI-Assistent");
    de.insert("ai_assist_button", "KI-Assistent");
    de.insert("ai_assist_prompt_label", "Beschreiben Sie die gewünschte Abfrage in natürlicher Sprache:");
    de.insert("ai_assist_prompt_hint", "z. B. Alle Benutzer dieses Monats auflisten");
    de.insert("ai_assist_generate", "SQL generieren");
    de.insert("ai_assist_insert", "In Editor einfügen");
    de.insert("ai_assist_generating", "SQL wird generiert…");
    de.insert("ai_assist_preview", "Generiertes SQL");
    de.insert("ai_assist_trust_note", "Vor dem Ausführen prüfen — SQL wird nie automatisch ausgeführt.");
    de.insert("ai_assist_disabled", "KI-Assistent unter Einstellungen → KI-Assistent aktivieren.");
    de.insert("ai_assist_inserted", "SQL in Editor eingefügt");
    de.insert("ai_assist_failed", "KI-Anfrage fehlgeschlagen");
    de.insert("cmd_ai_assist", "KI-Assistent");
    de.insert("cmd_hint_ai_assist", "Natürliche Sprache zu SQL");
    de.insert("settings_desc_ai_assistant", "SQL-Generierung in natürlicher Sprache aktivieren");
    de.insert("settings_row_ai_endpoint", "API-Endpunkt");
    de.insert("settings_desc_ai_endpoint", "Standard-URL überschreiben (optional)");
    de.insert("settings_row_ai_api_key", "API-Schlüssel");
    de.insert("settings_desc_ai_api_key", "Oder OPENAI_API_KEY / ANTHROPIC_API_KEY setzen");
    de.insert("snippet_save_title", "Snippet speichern");
    de.insert("snippet_save_name", "Name");
    de.insert("snippet_save_tags", "Tags");
    de.insert("snippet_save_tags_hint", "Kommagetrennt, z. B. reporting, daily");
    de.insert("editor_save_snippet", "Speichern");
...
fn insert_i18n_ui_fallback(t: &mut Translation) {
    ...
    t.insert("tree_history_empty", "No queries yet");
    t.insert("tree_snippets_empty", "No snippets saved yet");
    t.insert("snippet_save_from_editor", "Save from editor");
    t.insert("snippet_saved", "Snippet saved");
    t.insert("snippet_deleted", "Snippet deleted");
    t.insert("snippet_insert", "Insert");
    t.insert("snippet_rename", "Rename");
    t.insert("snippet_rename_ok", "OK");
    t.insert("snippet_delete", "Delete");
    t.insert("cmd_open_snippets", "Open Snippets");
    t.insert("cmd_hint_open_snippets", "Saved query library");
    t.insert("cmd_sec_snippets", "Snippets");
    t.insert("cmd_hint_open_snippet", "Open snippet in editor");
    t.insert("drop_irreversible", "This action cannot be undone (DROP CASCADE).");
    t.insert("drop_dependents_title", "Dependents preview");
    t.insert("drop_dependents_loading", "Loading dependents…");
    t.insert("drop_dependents_oid_unavailable", "Could not resolve object OID — dependents preview unavailable.");
    t.insert("drop_dependents_fetch_failed", "Failed to load dependents: {0}");
    t.insert("drop_dependents_none", "No dependent objects found.");
    t.insert("drop_dependents_count", "Showing all {0} dependents");
    t.insert("drop_dependents_truncated", "Showing first {0} of more than {1} dependents (truncated)");
    t.insert("drop_cascade_confirm", "Drop CASCADE");
    t.insert("connection_ssh_enable", "Enable SSH tunnel");
    t.insert("connection_ssh_host", "SSH host");
    t.insert("connection_ssh_port", "SSH port");
    t.insert("connection_ssh_username", "SSH username");
    t.insert("connection_ssh_password", "SSH password");
    t.insert("ai_assist_title", "AI Assist");
    t.insert("ai_assist_button", "AI Assist");
    t.insert("ai_assist_prompt_label", "Describe the query you want in plain language:");
    t.insert("ai_assist_prompt_hint", "e.g. List all users created this month");
    t.insert("ai_assist_generate", "Generate SQL");
    t.insert("ai_assist_insert", "Insert into editor");
    t.insert("ai_assist_generating", "Generating SQL…");
    t.insert("ai_assist_preview", "Generated SQL");
    t.insert("ai_assist_trust_note", "Review before running — SQL is never executed automatically.");
    t.insert("ai_assist_disabled", "Enable AI assistant in Settings → AI Assist.");
    t.insert("ai_assist_inserted", "SQL inserted into editor");
    t.insert("ai_assist_failed", "AI request failed");
    t.insert("cmd_ai_assist", "AI Assist");
    t.insert("cmd_hint_ai_assist", "Natural language to SQL");
    t.insert("settings_desc_ai_assistant", "Enable natural-language SQL generation");
    t.insert("settings_row_ai_endpoint", "API endpoint");
    t.insert("settings_desc_ai_endpoint", "Override default URL (optional)");
    t.insert("settings_row_ai_api_key", "API key");
    t.insert("settings_desc_ai_api_key", "Or set OPENAI_API_KEY / ANTHROPIC_API_KEY");
    t.insert("snippet_save_title", "Save Snippet");
    t.insert("snippet_save_name", "Name");
    t.insert("snippet_save_tags", "Tags");
    t.insert("snippet_save_tags_hint", "Comma-separated, e.g. reporting, daily");
    t.insert("editor_save_snippet", "Save");
